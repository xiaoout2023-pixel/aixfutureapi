...
DB_CONFIGS = {
    ...
    "uat": {
        "url": os.environ.get("TURSO_UAT_URL", "libsql://modelinfos-xiaoout.aws-us-west-2.turso.io"),
        "token": os.environ.get("TURSO_UAT_TOKEN", "eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJhIjoicnciLCJpYXQiOjE3Nzc1ODQ1ODgsImlkIjoiMDE5ZGUwNGItZGMwMS03MWRkLTkzZWMtMDA4NjkwZWFkMDdkIiwicmlkIjoiM2JlN2UzZGEtMGRkMy00ZGIxLWIyNTQtZmZmOGUyZjMwYTQ5In0.BYXvLKDMiqMSXbx0qyzMSOSVligJA5pk_4i8QclpkLQUxkzXxAYTrmiusZVPm-nRKgeiWIt9Bs89P0ApQXqAAA"),
    },
    "prod": {
